...
import { SmallCard, H12redTwo600, H14blackOne600, H14Danger400, H14blackTwo400, H12Primary400, H18BlackOne700, H12blackTwo600, H14blackTwo600 } from '../../utils/styledComponents';
import { colors } from '../../utils/theme/colors';
import { flex1, mt10, mh10, mv10, flexRow, justifyBetween, alignItemCenter, justifyCenter, mb5, mt5, mh15, mr5, alignSelfCenter, justifyStart, ml15, ml10 } from '../../utils/theme/commonStyles';
...
const AddDeliverChallanScreen = ({ route }: any) => {
    ...
    const handleSaveBtnClick = () => {
        setIsActiveBtn(true);
        navigation.navigate(screenName.DeliveryChallanDetails as never)
    };
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={[flex1, mt10, mh10]}>
                    ...
                    <SmallCard style={mv10}>
                        <H12redTwo600 style={[mh10]}>Delivery Challan Id : DC - 000016</H12redTwo600>
                    </SmallCard>
                    ...
                    <View style={[flexRow, justifyBetween]}>
                        <CustomTextInputField width={165} name={formKeys.invoiceDate} control={control} placeholder={''} label={labels.deliveryChalanDate} showIcon={true} showCalendar={true} iconName='calendar' iconType='Feather' iconSize={16} />
                    ...
                    <CustomTextInputField name={formKeys.referenceNumber} control={control} placeholder={labels.enterReferenceNumber} label={labels.referenceNumber} />
                    {
                        isAddedProductAvailable ? (
                            ...
                            <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen, { fromScreen: labels.deliveryChallan } as never)} color={colors.primary} />
                        )
                    }
