...
import { alignItemCenter, alignSelfCenter, flex1, flexRow, justifyBetween, justifyCenter, justifyStart, mb5, mh10, mh15, ml10, ml15, mr5, mt10, mt5, mv10 } from '../../utils/theme/commonStyles';
...
const AddInvoiceScreen = ({ route }: any) => {
    ...
    console.log(isAddedProductAvailable, '=======')
            ...
            <View style={[flex1]}>
                <ScrollView>
                    <View style={{ paddingBottom: 80 }}>
                        <ModalTopText title='Edit Product' iconPress={setEditProductModal(false)} toggleBtn={()=>{}} />
                        <View style={[mv10]}>
        ...
        <View style={[flex1, { backgroundColor: colors.white }]}>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={[flex1, mt10, mh10]}>
                    <TopHeader headerText={labels.addInvoice} searchIcon={false} />
                    <SmallCard style={mv10}>
                        <H12redTwo600 style={[mh10]}>Invoice no : #INV1244544</H12redTwo600>
                    </SmallCard>
                    ...
                    <View style={[flexRow, justifyBetween]}>
                        <CustomTextInputField width={165} name={formKeys.invoiceDate} control={control} placeholder={labels.enterInvoiceDate} label={labels.invoiceDate} showIcon={true} showCalendar={true} iconName='calendar' iconType='Feather' iconSize={16} />
                        <CustomTextInputField width={165} name={formKeys.dueDate} control={control} placeholder={labels.eneterDueDate} label={labels.dueDate} showIcon={true} showCalendar={true} iconName='calendar' iconType='Feather' iconSize={16} />
                    </View>
                    <CustomTextInputField name={formKeys.paymentMethod} control={control} placeholder={labels.enterPaymentMethod} label={labels.paymentMethod} showIcon={true} />
                    {
                        isAddedProductAvailable ? (
                            ...
                            <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen, { fromScreen: labels.invoice } as never)} color={colors.primary} />
                        )
                    }
